        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-shazmeen-red text-white hover:bg-shazmeen-red/90 transition-all duration-300 rounded-xl px-8 py-4 font-bold text-lg">
                View Courses
              </Button>
              <Button className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-black transition-all duration-300 rounded-xl px-8 py-4 font-bold text-lg">
                Book 1:1 Coaching
              </Button>
            </div>
          </div>
