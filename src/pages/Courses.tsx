      ...
      <section className="bg-gradient-to-r from-shazmeen-dark to-[#1a2d43] text-shazmeen-white pt-28 pb-16">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-shazmeen-red/20 text-shazmeen-blush mb-6">
                  ...
                  >
                    <div className={`grid lg:grid-cols-2 gap-8 lg:gap-12 items-start`}>
                      ...
                      <div className={`relative group ${!isEven ? 'lg:order-2' : ''}`}>
                        <div className="absolute inset-0 bg-gradient-to-br from-shazmeen-red/20 to-amber-500/20 rounded-3xl transform rotate-2 group-hover:rotate-4 transition-transform duration-500" />
                        <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                          {course.image ? (
                            ...
                            <div className="w-full h-[350px] lg:h-[450px] bg-gradient-to-br from-shazmeen-dark to-shazmeen-red flex items-center justify-center">
                          ...
                          {course.duration_text && (
                            <div className="absolute top-6 left-6">
                              <span className="bg-white/95 backdrop-blur-sm rounded-full px-4 py-2 text-sm font-semibold text-shazmeen-dark shadow-lg">
                                {course.duration_text}
                              </span>
                            </div>
                          )}
                          ...
                          {course.total_modules > 0 && (
                            <div className="absolute bottom-6 left-6">
                              <span className="bg-shazmeen-red/90 backdrop-blur-sm rounded-full px-4 py-2 text-sm font-semibold text-white shadow-lg">
                      ...
                      <div className={`${!isEven ? 'lg:order-1' : ''}`}>
                        {/* Subtitle */}
                        {course.subtitle && (
                          <p className="text-shazmeen-red font-medium mb-3">
                            {course.subtitle}
                          </p>
                        )}
                        
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-shazmeen-dark mb-6">
                          {course.title}
                        </h2>
                        ...
                        {/* CTA Text */}
                        {course.cta_text && (
                          <p className="text-shazmeen-red font-semibold italic mb-6 border-l-4 border-shazmeen-red pl-4">
                            {course.cta_text}
                          </p>
                        )}
