  ...
  return <section className="section-padding bg-white">
      <div className="container-custom">
        <div className="text-center mb-20">
          ...
          <div className="w-20 h-1 bg-shazmeen-red mx-auto mt-6"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Feature 1 */}
          <div className="premium-card p-8 card-hover">
            <div className="text-shazmeen-red mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 20.94c1.5 0 2.75 1.06 4 1.06 3 0 6-8 6-12.22A4.91 4.91 0 0 0 17 5c-2.22 0-4 1.44-5 2-1-.56-2.78-2-5-2a4.9 4.9 0 0 0-5 4.78C2 14 5 22 8 22c1.25 0 2.5-1.06 4-1.06Z"></path>
                <path d="M12 7V3"></path>
              </svg>
            </div>
            <h3 className="text-xl font-bold heading-elegant text-shazmeen-dark mb-4">Expert-Led Courses</h3>
          ...
          <div className="premium-card p-8 card-hover">
            ...
            <h3 className="text-xl font-bold heading-elegant text-shazmeen-dark mb-4">1:1 Coaching Sessions</h3>
          ...
          <div className="premium-card p-8 card-hover">
            ...
            <h3 className="text-xl font-bold heading-elegant text-shazmeen-dark mb-4">Inspiring Podcasts</h3>
          ...
          <div className="premium-card p-8 card-hover">
            ...
            <h3 className="text-xl font-bold heading-elegant text-shazmeen-dark mb-4">Free Downloads & Newsletter</h3>
