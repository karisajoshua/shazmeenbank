      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-lg mx-auto">
            <a href="https://tiktok.com/@shazmeen_bank" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-black text-white py-4 px-6 rounded-lg hover:opacity-90 transition-all">
            ...
            <a href="https://www.shazmeenbank.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-shazmeen-dark text-white py-4 px-6 rounded-lg hover:opacity-90 transition-all">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
