...
const LogoCarousel = () => {
  ...
  return <div className="bg-white py-12 border-y border-gray-100">
      ...
      <div className="overflow-hidden relative">
        <div className={`flex transition-opacity duration-1000 ${isVisible ? 'opacity-100 animate-super-slow-scroll' : 'opacity-0'}`}>
          ...
          {[...featuredLogos, ...featuredLogos].map((logo, index) => <div key={index} className="mx-8 flex-shrink-0">
              <img src={logo.logo} alt={`${logo.name} Logo`} className="h-16 object-contain" style={{
            maxWidth: "180px"
          }} />
            </div>)}
        </div>
